...
const Header: React.FC = () => {
  ...
  return (
      <header
          // GÜNCELLEME: 'fixed' yerine 'absolute' yapıldı.
          // 'h-24' sabit yüksekliği 'py-4' gibi esnek bir boşlukla değiştirebilirsiniz, ancak şimdilik yapıyı koruyoruz.
          className={`absolute top-0 py-1 z-50 w-full dark:bg-transparent transition-all ${
              sticky
